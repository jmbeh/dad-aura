...
<!-- Merged from SETUP.md on 2025-01-XX -->

### Prerequisites
- Node.js 18+ installed
- Supabase account (free tier works)
- Vonage account (optional for SMS, free trial available)
...
### Step 5: Vonage Setup (Optional - for SMS)

1. Go to https://dashboard.vonage.com and sign up
2. Get a phone number (free trial includes one)
3. Add Vonage credentials to `.env.local`
4. For local testing, use ngrok to expose your localhost:
   ```bash
   ngrok http 3000
   ```
5. In Vonage console, configure your phone number's webhook:
   - Webhook URL: `https://your-ngrok-url.ngrok.io/api/sms-webhook`
   - Method: HTTP POST
6. Send a test SMS to your Vonage number:
   - "🔥 +10"
   - "💩 -5"
   - "🎉 +15 Great job dad!"
...
5. Deploy!
6. Update Vonage webhook URL to your Vercel domain
...
- Check Vonage logs for delivery issues
